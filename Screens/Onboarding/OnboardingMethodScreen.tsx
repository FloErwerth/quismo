...
export const OnboardingMethodScreen = () => {
	...
	return (
		<OnboardingPage title={t("onboarding.method.title")}>
			<SizableText>{t("onboarding.method.intro1")}</SizableText>
			<Accordion>
				<Accordion.Item
					itemTitle={t("common.phases.preperation.naming.long") as string}
				>
					<View gap="$2">
				...
				<Accordion.Item
					itemTitle={t("common.phases.smokeStop.naming.long") as string}
				>
					<View gap="$2">
				...
				<Accordion.Item
					itemTitle={t("common.phases.stabilization.naming.long") as string}
				>
					<View gap="$2">
